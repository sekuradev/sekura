...
class CreateTest(TestCase):
    ...
    def test_get_returns_form(self):
        ...
        assert soup.form.get("action") == "/vendor/create/"
    ...
    def test_post_empty_returns_invalid_form(self):
        ...
        # WHEN
        r = self.client.post(reverse("vendor:create"))
    ...
    def test_post_valid(self):
        # GIVEN
        # WHEN
        self.client.post(reverse("vendor:create"), {"name": fake.name()})

        # THEN
        assert models.Vendor.objects.count() == 1
